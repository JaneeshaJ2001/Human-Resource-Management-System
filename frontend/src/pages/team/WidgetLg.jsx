    ...
    <div className="widgetLg">
      ...
      <table className="widgetLgTable">
        <tr className="widgetLgTr">
          ...
          <th className="widgetLgTh">Marital Status</th>
          <th className="widgetLgTh">DOB</th>
          <th className="widgetLgTh">Gender</th>
          <th className="widgetLgTh">No Of Dependents</th>
          <th className="widgetLgTh">DOJ</th>
          <th className="widgetLgTh">Department</th>
          <th className="widgetLgTh">Designation</th>
          <th className="widgetLgTh">Pay Grade</th>
